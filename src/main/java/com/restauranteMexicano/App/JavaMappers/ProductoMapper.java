...
public interface ProductoMapper {
    ...
    @Select("SELECT p.Id AS ProductoID, p.Nombre, p.Descripcion, pp.Cantidad, p.Precio,  p.Ingredientes,  p.TieneDescuento FROM T_PRODUCTOS p JOIN T_PEDIDO_PRODUCTO pp ON p.Id = pp.ProductoID JOIN T_PEDIDOS pe ON pe.ID = pp.PedidoID "+
    "WHERE  pe.ID = #{ID};")
